...
YinUtil::fastDifference(const double *in, double *yinBuffer, const size_t yinBufferSize) 
{
    ...
    //Vamp::FFTComplex fftcomplex(in,audioTransformedReal);
    //Vamp::FFT fft1;
    //fft1.forward(frameSize, in, nullImag, audioTransformedReal, audioTransformedImag);
   //fftcomplex.forward(in,audioTransformedReal);
