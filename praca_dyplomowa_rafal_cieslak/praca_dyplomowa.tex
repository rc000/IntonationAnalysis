...
Nagranie jest dzielone na ramki, skladajace sie z 1920 wartosci kazda. Kazda ramka jest odczytana jako obiekt klasy QAudioBuffer. Wektor typu QAudioBuffer zawiera cale wczytane nagranie.
\begin{lstlisting}
